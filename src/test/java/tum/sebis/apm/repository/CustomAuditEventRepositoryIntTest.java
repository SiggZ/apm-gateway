...
import tum.sebis.apm.config.audit.AuditEventConverter;
import tum.sebis.apm.domain.PersistentAuditEvent;
...
import static tum.sebis.apm.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
